...
fn is_colliding(x: &Vec<f64>, p: &Vec<f64>, n_dim: usize,
...
fn dataset_generation(n_data: usize, n_obs: usize, collision_limit: f64){
...
fn main() {
    ...
    if generate {dataset_generation(n_data,n_obs,collision_limit);}
