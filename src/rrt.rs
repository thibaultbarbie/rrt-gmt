...
/*
   This file has been modified by Thibault Barbie in March  2018.
*/
        ...
        match extend_status {
            ...
            ExtendStatus::Advanced(new_id) | ExtendStatus::Reached(new_id) => {
                    ...
                    tree_b.connect(&q_new, extend_length, &mut is_free)
                {
                    ...
                    return Ok(RRTSolution{path: a_all, iterations: i+1});
                }
            }
        }
...
/// Use the GMT algorithm to initialize RRT-connect
pub fn rrt_connect_gmt<FF, FR>(start: &[f64],
                               goal: &[f64],
                               mut is_free: FF,
                               random_sample: FR,
                               extend_length: f64,
